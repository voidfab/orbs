...
import { applyShapeWear, STATE_BY_ID, type Pose, type StateDef, type StateId } from './states'
...
export class BotEngine {
  ...
  private posed(
    ...
    if (shape) pose = applyShapeWear(def, pose, shape, t)
    return pose
  }
