...
const USAGE_SNIPPET = `import { ThinkingOrb } from 'react-native-thinking-orbs';\n\n<ThinkingOrb state="listening" size={64} />`;
    ...
    <main className="flex flex-col items-center max-w-[883px] mx-auto w-full px-6 pb-16 max-sm:px-4 max-sm:pb-12">
      ...
      <section className="w-full mb-6" aria-label="Installation">
        ...
        <div className="flex items-center h-10 bg-(--code-bg) rounded-[10px] py-0.5 pr-10 pl-3 overflow-hidden relative">
          <code className="font-[Roboto_Mono,monospace] text-sm leading-[22px] text-(--code-text) whitespace-pre overflow-x-auto min-w-0 flex-1">npm install react-native-thinking-orbs</code>
          <CopyButton getText={() => 'npm install react-native-thinking-orbs'} />
        </div>
      </section>
